...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('küfür-engel')
    .setDescription('Küfür Engel Sistemini Ayarla')
    ...
    .addChannelOption(option =>
      option.setName('log')
        .setDescription('Küfür Engel Log Kanalını Ayarla')
        .setRequired(true)
  ...
  run: async (client, interaction) => {
    ...
    if (islem === "sistem") {
      db.set(`küfürengel_${interaction.guild.id}`, true)
      db.set(`küfürlog_${interaction.guild.id}`, kanal.id)
      const ayarlandı = new EmbedBuilder()
        .setColor(0x00ff00)
        .setAuthor({ name: "Versty", iconURL: interaction.user.avatarURL() })
        .setDescription(`Küfür Engel Sistemi Başarıyla Ayarlandı! Log Kanalı: ${kanal}`)
        .setTimestamp()
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`
      Küfür Engel Sistemini Sıfırlamak İstediğine Eminmisin!
      `)
      ...
      const onay = new EmbedBuilder()
        ...
        .setAuthor({ name: "Sıfırlama İşlemi", iconURL: interaction.user.avatarURL() })
        .setDescription(`
      Küfür Engel Sistemi Sıfırlandı!
      `)
      const iptal = new EmbedBuilder()
        .setColor(0xff0000)
        .setAuthor({ name: "Sıfırlama İşlemi", iconURL: interaction.user.avatarURL() })
        .setDescription(`
      Küfür Engel Sistemini Sıfırlama İşlemi İptal Edildi!
      `)
      ...
      if (confirmation.customId === 'confirm') {
        ...
        db.delete(`küfürlog_${interaction.guild.id}`)
