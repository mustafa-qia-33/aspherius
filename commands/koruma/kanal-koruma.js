...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription('Kanal Koruma Sistemini Ayarla')
    ...
    .addChannelOption(option =>
      option.setName('log')
        .setDescription('Kanal Koruma Log Kanalını Ayarla')
        .setRequired(true)
  ...
  run: async (client, interaction) => {
    ...
    if (islem === "sistem") {
      db.set(`kanalkoruma_${interaction.guild.id}`, true)
      ...
      const ayarlandı = new EmbedBuilder()
        ...
        .setDescription(`Kanal Koruma Sistemi Başarıyla Ayarlandı! Log Kanalı: ${kanal}`)
        .setTimestamp()
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`
      Kanal Koruma Sistemini Sıfırlamak İstediğine Eminmisin!
      `)
