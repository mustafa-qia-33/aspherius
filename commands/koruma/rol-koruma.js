...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('rol-koruma')
    .setDescription('Rol Koruma Sistemini Ayarla')
    ...
    .addChannelOption(option =>
      option.setName('log')
        .setDescription('Rol Koruma Log Kanalını Ayarla')
        .setRequired(true)
  ...
  run: async (client, interaction) => {
    ...
    if (islem === "sistem") {
      db.set(`rolkoruma_${interaction.guild.id}`, true)
      ...
      const ayarlandı = new EmbedBuilder()
        ...
        .setDescription(`Rol Koruma Sistemi Başarıyla Ayarlandı! Log Kanalı: ${kanal}`)
        .setTimestamp()
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`
      Rol Koruma Sistemini Sıfırlamak İstediğine Eminmisin!
      `)
