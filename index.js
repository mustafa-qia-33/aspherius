...
role.delete()      
       ...
       ).setThumbnail(client.user.displayAvatarURL()).setTimestamp().setFooter({text: "Versty Koruma"})]})   
...
client.on('emojiDelete', async (emoji) => {
  ...
  ).setThumbnail(client.user.displayAvatarURL()).setTimestamp().setFooter({text: "Versty Koruma"})]}).catch(err => { })
